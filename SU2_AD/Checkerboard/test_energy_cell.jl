...
for cx=1:2
    for cy=1:2
        ...
        if B_ind==1
            ...
            Tm=iPESS_a.Tm;
            BL=iPESS_a.B_L;
            @tensor BL[:]:=BL[-1,1,-3]*U[-2,1];
            @tensor Tm[:]:=Tm[1,-2,-3,-4]*U'[1,-1];
            iPESS_a=Checkerboard_iPESS(BL,iPESS_a.B_U,Tm);
            x_tem[cx,cy]=iPESS_a;
        ...
        elseif B_ind==4
            ...
            Tm=iPESS_a.Tm;
            BU=iPESS_a.B_U;
            @tensor BU[:]:=BU[-1,1,-3]*U[-2,1];
            @tensor Tm[:]:=Tm[-1,-2,-3,1]*U'[1,-4];
            iPESS_a=Checkerboard_iPESS(iPESS_a.B_L,BU,Tm);
            x_tem[cx,cy]=iPESS_a;
        ...
        elseif B_ind==3
            ...
            Tm=iPESS_a.Tm;
            BL=iPESS_b.B_L;
            @tensor BL[:]:=BL[1,-2,-3]*U[-1,1];
            @tensor Tm[:]:=Tm[-1,-2,1,-4]*U'[1,-3];
            iPESS_a=Checkerboard_iPESS(iPESS_a.B_L,iPESS_a.B_U,Tm);
            iPESS_b=Checkerboard_iPESS(BL,iPESS_b.B_U,iPESS_b.Tm);
            x_tem[cx,cy]=iPESS_a;
        ...
        elseif B_ind==2
            ...
            Tm=iPESS_a.Tm;
            BU=iPESS_b.B_U;
            @tensor BU[:]:=BU[1,-2,-3]*U[-1,1];
            @tensor Tm[:]:=Tm[-1,1,-3,-4]*U'[1,-2];
            iPESS_a=Checkerboard_iPESS(iPESS_a.B_L,iPESS_a.B_U,Tm);
            iPESS_b=Checkerboard_iPESS(iPESS_b.B_L,BU,iPESS_b.Tm);
            x_tem[cx,cy]=iPESS_a;
