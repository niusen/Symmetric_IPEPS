...
v_init=TensorMap(randn, space(AA,1)*space(AA,1)*space(AA,1)*space(AA,1),GradedSpace[Irrep[U₁]⊠Irrep[SU₂]]((0,0)=>1));
...
v_init=TensorMap(randn, space(AA,3)*space(AA,3)*space(AA,3)*space(AA,3),GradedSpace[Irrep[U₁]⊠Irrep[SU₂]]((0,0)=>1)');
