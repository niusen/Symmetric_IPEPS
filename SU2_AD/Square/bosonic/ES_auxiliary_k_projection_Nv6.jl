...
include(joinpath(@__DIR__, "..", "..", "..", "..", "src", "mps_algorithms", "Projector_funs.jl"))
...
ind2=100;
@time begin
    @tensor AA6a[:]:= projectors[ind1][-8,1]*AA_3[-1,3,-5,1]*AA_3[-2,4,-6,3]*AA_3[-3,2,-7,4]*projectors[ind2]'[2,-4];
    @tensor vl_[:]:=vl0[1,2,3,-6,-7,-8]*AA6a[1,2,3,-2,-3,-4,-5,-1];
    AA6a=nothing;
    @tensor AA6b[:]:= projectors[ind2][-8,1]*AA_3[-1,3,-5,1]*AA_3[-2,4,-6,3]*AA_3[-3,2,-7,4]*projectors[ind1]'[2,-4];
