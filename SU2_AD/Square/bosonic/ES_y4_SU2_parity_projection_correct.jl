...
gate_upper=parity_gate(U_L',1);
@tensor gate_upper[:]:=U_L[-1,3,2]*gate_upper[3,1]*U_L'[1,2,-2]

gate_lower=parity_gate(U_L',2);
@tensor gate_lower[:]:=U_L[-1,1,3]*gate_lower[3,2]*U_L'[1,2,-2]
...
VR=evr[1];#L1,L2,L3,L4,dummy
VL=evl[4];#dummy,R1,R2,R3,R4
