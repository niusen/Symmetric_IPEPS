...
for cc in eachindex(chi_set)
    ...
    triangle_up_set,triangle_dn_set,SS_x_set,SS_y_set,SS_diagonal_set=evaluate_spin_ob_cell(parameters, A_cell_iPEPS, AA_cell, CTM_cell, LS_ctm_setting, energy_setting);
    @show triangle_up_set
    @show triangle_dn_set
    @show SS_x_set
    @show SS_y_set
    @show SS_diagonal_set
