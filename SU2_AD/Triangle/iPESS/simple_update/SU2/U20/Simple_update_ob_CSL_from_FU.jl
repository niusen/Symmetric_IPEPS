...
optim_setting.init_statenm="FU_iPESS_LS_D_8_chi_80.jld2";#"SU_iPESS_SU2_csl_D4.jld2";#"nothing";
...
tau=20;
dt=0.01;
B_set, T_set, λ_set1, λ_set2, λ_set3 = itebd_iPESS_Hofstadter_noHam(energy_setting, parameters, B_set, T_set, λ_set1, λ_set2, λ_set3, tau, dt,D_max, trun_tol);
...
# CTM_cell, AA_cell, U_L_cell,U_D_cell,U_R_cell,U_U_cell,ite_num,ite_err=Fermionic_CTMRG_cell(A_cell_iPEPS,chi,init, init_CTM,LS_ctm_setting);
# E_total,  ex_set, ey_set, e_diagonala_set, e0_set, eU_set=evaluate_ob_cell(parameters, A_cell_iPEPS, AA_cell, CTM_cell, LS_ctm_setting, energy_setting);
# println("chi,E="*string([chi,E_total]))
# println(ex_set)
# println(ey_set)
# println(e_diagonala_set)
# println(e0_set)
