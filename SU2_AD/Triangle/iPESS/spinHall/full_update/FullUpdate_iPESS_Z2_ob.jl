...
optim_setting.init_statenm="SU_iPESS_Z2_Triangle_Hofstadter_Hubbard_spinHall_D4.jld2";#"SU_iPESS_SU2_csl_D6_3.93877.jld2";#"nothing";
...
E_total,  ex_up_set, ey_up_set, e_diagonala_up_set, ex_dn_set, ey_dn_set, e_diagonala_dn_set, e0_set, eU_set, mx_ob_set, my_ob_set, mz_ob_set=evaluate_ob_cell(parameters, A_cell_iPEPS, AA_cell, CTM_cell, ENV_ctm_setting, energy_setting);
println(E_total)
println(ex_up_set)
println(ey_up_set)
