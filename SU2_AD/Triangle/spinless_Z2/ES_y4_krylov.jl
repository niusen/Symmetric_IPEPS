...
optim_setting.init_statenm="state.jld2";#"SimpleUpdate_D_6.jld2";#"nothing";
...
AA, U_L,U_D,U_R,U_U=build_double_layer_NoSwap(A',A);
...
AA1_Vodd_Vodd=Matrix{TensorMap}(undef,l_Vodd,l_Vodd);#upper layer, lower layer
AA1_Vodd_Veven=Matrix{TensorMap}(undef,l_Vodd,l_Veven);#upper layer, lower layer
AA1_Veven_Vodd=Matrix{TensorMap}(undef,l_Veven,l_Vodd);#upper layer, lower layer
AA1_Veven_Veven=Matrix{TensorMap}(undef,l_Veven,l_Veven);#upper layer, lower layer

AA4_Phyodd_Vodd_Vodd=Matrix{TensorMap}(undef,l_Vodd,l_Vodd);#upper layer, lower layer
AA4_Phyodd_Vodd_Veven=Matrix{TensorMap}(undef,l_Vodd,l_Veven);#upper layer, lower layer
AA4_Phyodd_Veven_Vodd=Matrix{TensorMap}(undef,l_Veven,l_Vodd);#upper layer, lower layer
AA4_Phyodd_Veven_Veven=Matrix{TensorMap}(undef,l_Veven,l_Veven);#upper layer, lower layer

AA4_Phyeven_Vodd_Vodd=Matrix{TensorMap}(undef,l_Vodd,l_Vodd);#upper layer, lower layer
AA4_Phyeven_Vodd_Veven=Matrix{TensorMap}(undef,l_Vodd,l_Veven);#upper layer, lower layer
AA4_Phyeven_Veven_Vodd=Matrix{TensorMap}(undef,l_Veven,l_Vodd);#upper layer, lower layer
AA4_Phyeven_Veven_Veven=Matrix{TensorMap}(undef,l_Veven,l_Veven);#upper layer, lower layer
...
v_init=TensorMap(randn, space(AA2_Phyodd,1)*space(AA2_Phyodd,1)*space(AA2_Phyodd,1)*space(AA2_Phyodd,1),Rep[ℤ₂](0=>1));
...
v_init=TensorMap(randn, space(AA2_Phyodd,3)*space(AA2_Phyodd,3)*space(AA2_Phyodd,3)*space(AA2_Phyodd,3),Rep[ℤ₂](0=>1)');
...
Qn=get_Vspace_parity(space(eu,1)); Qn=Int.(Qn);
...
if y_anti_pbc
    matwrite("ES_freefermion_Nv4_APBC"*".mat", Dict(
        "k_phase" => k_phase,
        "eu" => eu,
        "Qn"=>Qn
    ); compress = false)
else
    matwrite("ES_freefermion_Nv4"*".mat", Dict(
        "k_phase" => k_phase,
        "eu" => eu,
        "Qn"=>Qn
    ); compress = false)
