...
v_init=TensorMap(randn, space(AA2_set[1],1)*space(AA2_set[1],1)*space(AA2_set[1],1)*space(AA2_set[1],1),Rep[U₁ × SU₂]((0,0)=>1));
...
v_init=TensorMap(randn, space(BB2_set[1],3)*space(BB2_set[1],3)*space(BB2_set[1],3)*space(BB2_set[1],3),Rep[U₁ × SU₂]((0,0)=>1)');
