...
chi=100;
Dmax=8;
filenm="optim_4x4_D_3_chi_100_9.08588.jld2";
...
for ite=1:1#optim_maxiter
    ...
    for cp =2:2#length(bond_coord_set)
        global E_opt
        ...
        println("Energy simple cut= "*string(E_cuta))
        ...
        println("Energy gauge fix cut= "*string(E_cutb))
        if E_cutb<E_cuta
            psi_tem=psi_newb;
            E_opt_new=E_cutb;
        else
