...
∂E=gradient(x ->cost_fun_bra_ket(N_operator_sites,x,A_ket,pos_bra,pos_ket,psi,psi,psi_double_open,psi_double,U_s_s,"energy",real_imag), A_bra)[1];
∂N=gradient(x ->cost_fun_bra_ket(N_operator_sites,x,A_ket,pos_bra,pos_ket,psi,psi,psi_double_open,psi_double,U_s_s,"norm",real_imag), A_bra)[1];
