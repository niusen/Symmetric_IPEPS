...
A_new=zeros(6,6,6,6,2)*im;
A_new[[1,2,3],[1,2,3],[1,2,3],[1,2,3],:]=convert(Array,A);
A=TensorMap(A_new,Rep[SU₂](0=>1, 1/2=>1,1=>1) ⊗ Rep[SU₂](0=>1, 1/2=>1,1=>1) ⊗ Rep[SU₂](0=>1, 1/2=>1,1=>1)' ⊗ Rep[SU₂](0=>1, 1/2=>1,1=>1)', Rep[SU₂](1/2=>1));
