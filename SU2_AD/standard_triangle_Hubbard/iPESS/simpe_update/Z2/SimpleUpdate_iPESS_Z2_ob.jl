...
μ=0;
U=0;
@show parameters=Dict([("t1", t1),("t2", t2), ("μ",  μ), ("U",  U)]);
...
Base.Sys.set_process_title("C"*string(n_cpu)*"_"*"SU_U"*string(U)*"_D"*string(D_max))
pid=getpid();
...
filenm="SU_iPESS_Z2_mu_D"*string(D_max)*".jld2";
