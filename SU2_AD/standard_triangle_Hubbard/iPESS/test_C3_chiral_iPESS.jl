...
B_set[1,1]=TensorMap(randn,V*V,V');
T_set[1,1]=TensorMap(randn,V',Vp'*V*V);
...
B_set_C3,T_set_C3=to_C3_symmetric_fiPESS(B_set,T_set,0);

B_even_set,B_odd_set,T_even_set,T_odd_set=inversion_projection_fiPESS(B_set_C3,T_set_C3);

B_set=B_even_set+B_odd_set*im;
T_set=T_even_set+T_odd_set*im;
