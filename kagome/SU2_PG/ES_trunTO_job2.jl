...
display("group information:");flush(stdout);
display(DTrun_FLR_eig);flush(stdout);
...
display("group information:");flush(stdout);
display(Dtrun_GLR_eig);flush(stdout);
...
display("group information:");flush(stdout);
display(DTrun_FLR_svd);flush(stdout);
...
display("group information:");flush(stdout);
display(Dtrun_GLR_svd);flush(stdout);
