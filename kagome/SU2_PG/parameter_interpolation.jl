...
function interpolation(parameters,parameter,parameterL,parameterR,stateL, stateR, D, chi, CTM_conv_tol,CTM_ite_nums,CTM_trun_tol)
    ...
    println("linear change parameter");
        ...
        C1=abs(parameter-parameterR)/abs(parameterL-parameterR);
        C2=1-C1;
...
function run_parameter_interpolation(parameters,parameter,parameterL,parameterR,D,chi,CTM_conv_tol,CTM_ite_nums,CTM_trun_tol,Bond_irrep,Triangle_irrep,nonchiral,init_statenmL,init_statenmR)
    ...
    interpolation(parameters,parameter,parameterL,parameterR,stateL, stateR, D, chi, CTM_conv_tol,CTM_ite_nums,CTM_trun_tol)
