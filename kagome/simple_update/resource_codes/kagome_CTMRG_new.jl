...
function CTMRG(A,chi,conv_check,tol,init,CTM_ite_nums, CTM_trun_tol,CTM_ite_info=true,CTM_conv_info=false)
    ...
    for ci=1:CTM_ite_nums
        ...
        for direction in direction_order
            Cset,Tset=CTM_ite(Cset, Tset, AA_rotated[direction], chi, direction,CTM_trun_tol,CTM_ite_info);
        end
...
function CTM_ite(Cset, Tset, AA, chi, direction, trun_tol,CTM_ite_info)
...
function CTM_ite_trunSVD(Cset, Tset, AA_fused, chi, direction, trun_tol,CTM_ite_info)
